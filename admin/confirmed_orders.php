...
<head>
    ...
    <link rel="stylesheet" href="style/confirm_orders.css" />
    <link
        rel="stylesheet"
...
<body>
    <p class="order-title">Confirmed Orders</p>
    ...
    if ($distinct_emails_result && mysqli_num_rows($distinct_emails_result) > 0) {
        while ($row = mysqli_fetch_assoc($distinct_emails_result)) {
            ...
            $select_orders_query = "SELECT * FROM orders WHERE email = '$email' AND status = 'Confirmed'";
    ...
    ?>
            <div class="cart">
                ...
                ?>
                        ...
                        <div class="cart-item">
                            <div class="product">
                                <img src="../assets/products/<?php echo $data['img']; ?>" alt="Floral Print Wrap Dress" />
